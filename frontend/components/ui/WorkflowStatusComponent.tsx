...
const steps = [
    ...
    {
        id: WorkflowStatus.ProposalsRegistrationStarted,
        label: statusMessages[WorkflowStatus.ProposalsRegistrationStarted],
    },
            ...
            {steps.map((step, index) => (
                <li
                    ...
                    className={`flex md:w-full items-center ${
                        index <= currentStepIndex ? 'text-teal-500' : 'text-gray-600'
                    } sm:after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-4 xl:after:mx-8 mb-4`}
                >
                    <div className="flex items-center whitespace-nowrap after:content-['/'] sm:after:hidden after:mx-2">
                        <span
                            className={`w-6 h-6 ${
                                index <= currentStepIndex
                                    ? 'bg-teal-600 border-teal-200 text-white'
